...
def test_handle_event():
    ...
    with open(file_path, 'rb') as file_in:
        with fsspec.open('s3://sti-bus-delays/2024/08/2024-08-25-test-data.csv', 'wb') as file_out:
    ...
    assert json.loads(http_response['body'])['message'] == 'Monthly charts generated'
